...
#
# RC2014_fpga.tcl: Tcl script for re-creating project 'RC2014_fpga'
#
# Generated by Vivado on Thu Mar 14 19:26:59 -0700 2019
...
#
# 1. This project restoration tcl script (RC2014_fpga.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/richa/gitrepo/RC2014_fpga/zedboard/RC2014_fpga/RC2014_fpga.srcs/sources_1/ip/CPM_BASIC/CPM_BASIC.xci"
#    "C:/Users/richa/gitrepo/RC2014_fpga/zedboard/RC2014_fpga/RC2014_fpga.srcs/sources_1/ip/SCM_V100_S3_SCS3_32K/SCM_V100_S3_SCS3_32K.xci"
#    "C:/Users/richa/gitrepo/RC2014_fpga/zedboard/RC2014_fpga/RC2014_fpga.srcs/sources_1/ip/R0001009/R0001009.xci"
#    "C:/Users/richa/gitrepo/RC2014_fpga/zedboard/RC2014_fpga/RC2014_fpga.srcs/constrs_1/new/RC2014_fpga.xdc"
#
...
#    "C:/Users/richa/gitrepo/RC2014_fpga/roms/CPM_BASIC.coe"
#    "C:/Users/richa/gitrepo/RC2014_fpga/roms/SCMonitor-v100-S3-SCS3-32k-ROM.coe"
#    "C:/Users/richa/gitrepo/RC2014_fpga/roms/R0001009.coe"
#
#*****************************************************************************************
...
set _xil_proj_name_ "RC2014_fpga"
...
set script_file "RC2014_fpga.tcl"
...
set files [list \
 [file normalize "${origin_dir}/../../rtl/frac20.vhd"] \
 [file normalize "${origin_dir}/../../rtl/T80/T80_Pack.vhd"] \
 [file normalize "${origin_dir}/../../rtl/T80/T80s.vhd"] \
 [file normalize "${origin_dir}/../../rtl/single_port_ram.vhd"] \
 [file normalize "${origin_dir}/../../rtl/decoder_3x8.vhd"] \
 [file normalize "${origin_dir}/../../rtl/ROM_Page_Select.vhd"] \
 [file normalize "${origin_dir}/../../rtl/acia6850.vhd"] \
 [file normalize "${origin_dir}/../../rtl/T80/T80.vhd"] \
 [file normalize "${origin_dir}/../../rtl/T80/T80_ALU.vhd"] \
 [file normalize "${origin_dir}/../../rtl/T80/T80_MCode.vhd"] \
 [file normalize "${origin_dir}/../../rtl/T80/T80_Reg.vhd"] \
 [file normalize "${origin_dir}/../../rtl/RC2014_fpga.vhd"] \
 [file normalize "${origin_dir}/../../roms/CPM_BASIC.coe"] \
 [file normalize "${origin_dir}/../../roms/SCMonitor-v100-S3-SCS3-32k-ROM.coe"] \
 [file normalize "${origin_dir}/../../roms/R0001009.coe"] \
]
add_files -norecurse -fileset $obj $files

# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/RC2014_fpga.srcs/sources_1/ip/CPM_BASIC/CPM_BASIC.xci" ]\
 [file normalize "${origin_dir}/RC2014_fpga.srcs/sources_1/ip/SCM_V100_S3_SCS3_32K/SCM_V100_S3_SCS3_32K.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../../rtl/frac20.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/T80/T80_Pack.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/T80/T80s.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/single_port_ram.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/decoder_3x8.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/ROM_Page_Select.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/acia6850.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/T80/T80.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/T80/T80_ALU.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/T80/T80_MCode.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/T80/T80_Reg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "$origin_dir/../../rtl/RC2014_fpga.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "CPM_BASIC/CPM_BASIC.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "SCM_V100_S3_SCS3_32K/SCM_V100_S3_SCS3_32K.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set obj [get_filesets sources_1]
set_property -name "top" -value "RC2014_fpga" -objects $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/RC2014_fpga.srcs/sources_1/ip/R0001009/R0001009.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "R0001009/R0001009.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set file "[file normalize "$origin_dir/RC2014_fpga.srcs/constrs_1/new/RC2014_fpga.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/RC2014_fpga.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *new/RC2014_fpga.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/RC2014_fpga.xdc]" -objects $obj
